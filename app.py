...
def main():
    ...
    PORTFOLIO_STYLES = {
        "Swing Trading": {
            ...
            "mixes": {
                "Bull Market Mix": {
                    "strategies": ['CL2', 'CL3', 'VolatilitySurfer', 'PR_v1', 'VC', 'AP'],
                ...
                "Bear Market Mix": {
                    "strategies": ['VolatilitySurfer', 'MOM_v1', 'MomentumMasters', 'VC', 'AP'],
                ...
                "Chop/Consolidate Mix": {
                    "strategies": ['VolatilitySurfer', 'MomentumMasters', 'MOM_v1', 'VC', 'AP'],
        ...
        "SIP Investment": {
            ...
            "mixes": {
                "Bull Market Mix": {
                    "strategies": ['CL_v1', 'CL2', 'VolatilitySurfer', 'MOM_v1', 'VC', 'AP'],
